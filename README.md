...
- `OnceDone-v1.0.1.dmg`：可拖拽安装的 macOS 安装包。
- `OnceDone-v1.0.1.sha256`：安装包 SHA-256 校验文件。
...
1. 在 [Releases](https://github.com/bytebiu/OnceDone/releases) 下载 `OnceDone-v1.0.1.dmg`。
...
更新时可以从菜单栏打开“检查更新...”，OnceDone 会跳转到设置里的检查更新模块并开始查询。OnceDone 只识别正式 GitHub Release，不使用 `pre-release` 版本作为自动更新来源。点击“立即更新”后会显示下载、校验和安装进度。
